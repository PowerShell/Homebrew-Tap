...
class PowershellLts < Formula
  ...
  url "https://github.com/PowerShell/PowerShell/releases/download/v7.0.6/powershell-7.0.6-osx-x64.tar.gz"
  version "7.0.6"
  # must be lower-case
  sha256 "4501e5c7093289ab8fb5fd1fbd58789e4e534fa6bb097f9306022d62e2cf3132"
  version_scheme 1
  bottle :unneeded
