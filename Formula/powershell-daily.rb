...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20201024/powershell-7.1.0-daily.20201024-osx-x64.tar.gz"
  version "7.1.0-daily.20201024"
  # must be lower-case
  sha256 "0a423fe75328e1fb076ce2bae872f6a35597f6b78b17b94a4367c077d32a58ec"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20201024",
