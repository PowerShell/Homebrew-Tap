...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211027-2/powershell-7.2.0-daily20211027.2-osx-x64.tar.gz"
  version "7.2.0-daily20211027.2"
  # must be lower-case
  sha256 "c24b0c07fdb1796a9b3868b27107558212bfb54ef8c42a1cdadedf8fc28ea7c1"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20211027.2",
