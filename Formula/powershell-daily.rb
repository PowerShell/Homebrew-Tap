...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210612-2/powershell-7.2.0-daily20210612.2-osx-x64.tar.gz"
  version "7.2.0-daily20210612.2"
  # must be lower-case
  sha256 "73fd112040b1cb7597c906851de25c51c892aad332b7dcf6042cd7b72080c7bf"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210612.2",
