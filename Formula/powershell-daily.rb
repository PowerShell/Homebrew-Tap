...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210113/powershell-7.2.0-daily.20210113-osx-x64.tar.gz"
  version "7.2.0-daily.20210113"
  # must be lower-case
  sha256 "cd4a7607b0337a0eb1deb100bf7d7c1e52b4dc90ce0391b8e816762aafd0e19f"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210113",
