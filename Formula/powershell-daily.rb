...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210414-1/powershell-7.2.0-daily20210414.1-osx-x64.tar.gz"
  version "7.2.0-daily20210414.1"
  # must be lower-case
  sha256 "25ec5d0488927171e34f31fd03f6fb90d19a334adad8f2dedb4b4e368b663a05"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210414.1",
