...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210918-1/powershell-7.2.0-daily20210918.1-osx-x64.tar.gz"
  version "7.2.0-daily20210918.1"
  # must be lower-case
  sha256 "5c539700d94c74d3dea0a3ccecf2f17a03e17f5db5244a4df72c9a54efa3e117"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210918.1",
