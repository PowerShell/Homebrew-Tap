...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210707-1/powershell-7.2.0-daily20210707.1-osx-x64.tar.gz"
  version "7.2.0-daily20210707.1"
  # must be lower-case
  sha256 "55daa6a31625cd144104ccd492abf4cadb02d41dc8c252024c8e89b4b9a715c2"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210707.1",
