...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210616-1/powershell-7.2.0-daily20210616.1-osx-x64.tar.gz"
  version "7.2.0-daily20210616.1"
  # must be lower-case
  sha256 "312f50fbf47463eff76ad9718f27202e1df2acacb2ad9044d503100b47f2b339"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210616.1",
