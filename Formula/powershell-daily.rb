...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20201229/powershell-7.2.0-daily.20201229-osx-x64.tar.gz"
  version "7.2.0-daily.20201229"
  # must be lower-case
  sha256 "ab16bc2e11ca2ea96cd27e55aaf2a5651725af328d02a6213522218af27e179a"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20201229",
