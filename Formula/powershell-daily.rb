...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210810-1/powershell-7.2.0-daily20210810.1-osx-x64.tar.gz"
  version "7.2.0-daily20210810.1"
  # must be lower-case
  sha256 "b155e771684788fc64c3d3fe0e8f168c19741a6ed30292e19af2acbc1c5a8628"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210810.1",
