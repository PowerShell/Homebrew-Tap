...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211020-3/powershell-7.2.0-daily20211020.3-osx-x64.tar.gz"
  version "7.2.0-daily20211020.3"
  # must be lower-case
  sha256 "fd1f195ee415d6d150bf1cee319111fb59ac3a640e10d1ee5871bf984e573627"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20211020.3",
