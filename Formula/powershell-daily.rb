...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210910-1/powershell-7.2.0-daily20210910.1-osx-x64.tar.gz"
  version "7.2.0-daily20210910.1"
  # must be lower-case
  sha256 "f52d352487e7f9d8e80abffff22d6aeda16f06773ad94c37f7be8c7de42f97b2"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210910.1",
