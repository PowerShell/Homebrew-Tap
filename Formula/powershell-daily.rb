...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210412-1/powershell-7.2.0-daily20210412.1-osx-x64.tar.gz"
  version "7.2.0-daily20210412.1"
  # must be lower-case
  sha256 "e0a3df802430dfdc69959fd07a41c773baf2e0b403e86c271571b9620307a12a"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210412.1",
