...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200724/powershell-7.1.0-daily.20200724-osx-x64.tar.gz"
  version "7.1.0-daily.20200724"
  # must be lower-case
  sha256 "4642cf13b440419ef129db7e232bd7dc3fbbf66c23d1e230f4e81f4536c65e2d"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200724",
