...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200622/powershell-7.1.0-daily.20200622-osx-x64.tar.gz"
  version "7.1.0-daily.20200622"
  # must be lower-case
  sha256 "1e6325e224e4dfb8aa0330348ddf4c9323108a3af16a4acc2f26dee816476166"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200622",
