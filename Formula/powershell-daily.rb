...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210905-1/powershell-7.2.0-daily20210905.1-osx-x64.tar.gz"
  version "7.2.0-daily20210905.1"
  # must be lower-case
  sha256 "3aac10a28bf5e0fe7bad814595b0e9b8eca42773d3e5a65afa744240e25cb485"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210905.1",
