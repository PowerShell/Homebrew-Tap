...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210513-1/powershell-7.2.0-daily20210513.1-osx-x64.tar.gz"
  version "7.2.0-daily20210513.1"
  # must be lower-case
  sha256 "f879b9862f8a2a48ad8551408c5350b886711fa3244bfba96a366b205c577402"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210513.1",
