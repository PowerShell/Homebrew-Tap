...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210415-2/powershell-7.2.0-daily20210415.2-osx-x64.tar.gz"
  version "7.2.0-daily20210415.2"
  # must be lower-case
  sha256 "c758b37086861d2f1df412270565fd8d8d41d1110f37be0fc4c68faa1aadc612"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210415.2",
