...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211113-2/powershell-7.2.0-daily20211113.2-osx-x64.tar.gz"
  version "7.2.0-daily20211113.2"
  # must be lower-case
  sha256 "68100cec6cebc47976abcb66f1e5394aa20dad437f8a3a724edac371f2b4fae3"
  version_scheme 1
