...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211031-2/powershell-7.2.0-daily20211031.2-osx-x64.tar.gz"
  version "7.2.0-daily20211031.2"
  # must be lower-case
  sha256 "488fdad860d5ab59e41bd94cf9024d8cd4a15227f169c3e6e477b4906b5459e7"
  version_scheme 1
  ...
  test do
    assert_equal "7.2.0-daily20211031.2",
