...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200614/powershell-7.1.0-daily.20200614-osx-x64.tar.gz"
  version "7.1.0-daily.20200614"
  # must be lower-case
  sha256 "5b23052b2b21c8a806d032da7743cc807a866c1fce24e52ccd8729f6de788d41"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200614",
