...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20201001/powershell-7.1.0-daily.20201001-osx-x64.tar.gz"
  version "7.1.0-daily.20201001"
  # must be lower-case
  sha256 "421059244e0c4ecf5a62c048a23aea2c6ea4ec3def926a81e0ffbac2e42684e9"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20201001",
