...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200531/powershell-7.1.0-daily.20200531-osx-x64.tar.gz"
  version "7.1.0-daily.20200531"
  # must be lower-case
  sha256 "cc57a71f06308492bfc54cebadd0b526afbf48eebd9b8655b685b7c5346ad59c"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200531",
