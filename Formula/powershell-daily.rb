...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200615/powershell-7.1.0-daily.20200615-osx-x64.tar.gz"
  version "7.1.0-daily.20200615"
  # must be lower-case
  sha256 "de1a22ee5d1ceec25bfbfb6d2b558263930830c5987feed890af8a9c258d6fe9"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200615",
