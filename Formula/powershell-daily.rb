...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211008-1/powershell-7.2.0-daily20211008.1-osx-x64.tar.gz"
  version "7.2.0-daily20211008.1"
  # must be lower-case
  sha256 "3b650789206a04ee70cf0e20668b273d281bf874cf80766db9c7904d58a09604"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20211008.1",
