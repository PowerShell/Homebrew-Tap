...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210428-1/powershell-7.2.0-daily20210428.1-osx-x64.tar.gz"
  version "7.2.0-daily20210428.1"
  # must be lower-case
  sha256 "746cade4932ecd729acce012aabc3f5c2f286d4e6e5f25758a4b6494f1edb2a9"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210428.1",
