...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210902-1/powershell-7.2.0-daily20210902.1-osx-x64.tar.gz"
  version "7.2.0-daily20210902.1"
  # must be lower-case
  sha256 "8f8f71bb91337476e27cf12922fdb7894dc2dc780b608a4cdcdfcd08baf15809"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210902.1",
