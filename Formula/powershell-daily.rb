...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20201120/powershell-7.2.0-daily.20201120-osx-x64.tar.gz"
  version "7.2.0-daily.20201120"
  # must be lower-case
  sha256 "da2865778fb95f4cc49f273a89418bb7d244a72de4261fe6446daae1aaa8c2e8"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20201120",
