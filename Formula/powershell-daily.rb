...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210415-1/powershell-7.2.0-daily20210415.1-osx-x64.tar.gz"
  version "7.2.0-daily20210415.1"
  # must be lower-case
  sha256 "6e03d63ec111731a7a4d36b6051210aa752bb7c7cb05c1ae0ba700f9fbcfbd6c"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210415.1",
