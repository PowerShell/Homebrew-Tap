...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200529/powershell-7.1.0-daily.20200529-osx-x64.tar.gz"
  version "7.1.0-daily.20200529"
  # must be lower-case
  sha256 "d85dec1446274e93149896ad30296ad326c48f33acce1964318ba20d56d817b6"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200529",
