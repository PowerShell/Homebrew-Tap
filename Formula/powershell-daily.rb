...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210818-1/powershell-7.2.0-daily20210818.1-osx-x64.tar.gz"
  version "7.2.0-daily20210818.1"
  # must be lower-case
  sha256 "f0c3ef467a07356bcd34508ea1838817455e2ec85283d467d1a17e36ce2b93a9"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210818.1",
