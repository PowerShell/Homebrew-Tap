...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200901/powershell-7.1.0-daily.20200901-osx-x64.tar.gz"
  version "7.1.0-daily.20200901"
  # must be lower-case
  sha256 "47bcdf1fd9c30c23bda8c300ad50ecd88ba0e2fcfd6cf761b5dbfd003437727f"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200901",
