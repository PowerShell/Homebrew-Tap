...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20201003/powershell-7.1.0-daily.20201003-osx-x64.tar.gz"
  version "7.1.0-daily.20201003"
  # must be lower-case
  sha256 "26905fde68bd217fee4256b48cba6cfa5458347e68d3338265012d40a8ca1c92"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20201003",
