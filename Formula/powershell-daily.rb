...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210701-1/powershell-7.2.0-daily20210701.1-osx-x64.tar.gz"
  version "7.2.0-daily20210701.1"
  # must be lower-case
  sha256 "738aed83158c28e527ced1a1ef7f45c29fd8610750b09eb6b66449ef82076f0c"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210701.1",
