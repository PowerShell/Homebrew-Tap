...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20201121/powershell-7.2.0-daily.20201121-osx-x64.tar.gz"
  version "7.2.0-daily.20201121"
  # must be lower-case
  sha256 "5fb0bf6e7d1c13e7713322ca086a99b66326dd249aa5bf7c1168d154221c47f1"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20201121",
