...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211109-1/powershell-7.2.0-daily20211109.1-osx-x64.tar.gz"
  version "7.2.0-daily20211109.1"
  # must be lower-case
  sha256 "0fb16cb18f091da668797199c8e038b499ebeacd4d8806b432db7d3a51019b20"
  version_scheme 1
  ...
  test do
    assert_equal "7.2.0-daily20211109.1",
