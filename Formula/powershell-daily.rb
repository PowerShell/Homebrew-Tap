...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200929/powershell-7.1.0-daily.20200929-osx-x64.tar.gz"
  version "7.1.0-daily.20200929"
  # must be lower-case
  sha256 "fb6e49f9a6dff1e79dacd9cdc3f94ac655cf24077a3870ec48fa144c3542a044"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200929",
