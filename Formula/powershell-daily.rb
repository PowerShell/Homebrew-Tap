...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210908-1/powershell-7.2.0-daily20210908.1-osx-x64.tar.gz"
  version "7.2.0-daily20210908.1"
  # must be lower-case
  sha256 "592ead45734c1e76c4e83f5250e7b8c3b832e892fa80c27435d5928b96b93be2"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210908.1",
