...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210420-3/powershell-7.2.0-daily20210420.3-osx-x64.tar.gz"
  version "7.2.0-daily20210420.3"
  # must be lower-case
  sha256 "50ad83e565e70725fd9e62d9dfe1587053c27d8983bcc5f2ce280bcd262a2308"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210420.3",
