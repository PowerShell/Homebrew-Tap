...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210413-1/powershell-7.2.0-daily20210413.1-osx-x64.tar.gz"
  version "7.2.0-daily20210413.1"
  # must be lower-case
  sha256 "f29f5b5435a2b4ffa78e45917457757bca56b0aa8e71958d02a560ed00d913ab"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210413.1",
