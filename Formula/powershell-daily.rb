...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210303/powershell-7.2.0-daily.20210303-osx-x64.tar.gz"
  version "7.2.0-daily.20210303"
  # must be lower-case
  sha256 "f64819087005a47f7ba473aa3d7e3f2f68b02b2104a93a5cec6348b36aef1735"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210303",
