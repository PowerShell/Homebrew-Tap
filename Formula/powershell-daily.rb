...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200530/powershell-7.1.0-daily.20200530-osx-x64.tar.gz"
  version "7.1.0-daily.20200530"
  # must be lower-case
  sha256 "eac9df94e3fc88b9cc192b2044c64debc4fe346420008f5994bf84dfa0296354"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200530",
