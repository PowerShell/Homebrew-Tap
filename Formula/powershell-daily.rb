...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210618-1/powershell-7.2.0-daily20210618.1-osx-x64.tar.gz"
  version "7.2.0-daily20210618.1"
  # must be lower-case
  sha256 "24a7ca597f01d62219dead3cf4f3e0acd84a476f739980230e1fc621c2bc8061"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210618.1",
