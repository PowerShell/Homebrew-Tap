...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210704-1/powershell-7.2.0-daily20210704.1-osx-x64.tar.gz"
  version "7.2.0-daily20210704.1"
  # must be lower-case
  sha256 "9ee54ce11beaa33df508bff3985359a3b3dbe321b50c1e55ae126e8369f4b865"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210704.1",
