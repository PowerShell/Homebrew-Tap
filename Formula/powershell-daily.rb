...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210129/powershell-7.2.0-daily.20210129-osx-x64.tar.gz"
  version "7.2.0-daily.20210129"
  # must be lower-case
  sha256 "f0d16bf08839de1f64cf6a5fa253e7bd055e74f4a1e0fb5695a08c1cc88db50d"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210129",
