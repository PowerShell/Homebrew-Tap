...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211028-1/powershell-7.2.0-daily20211028.1-osx-x64.tar.gz"
  version "7.2.0-daily20211028.1"
  # must be lower-case
  ...
  test do
    assert_equal "7.2.0-daily20211028.1",
