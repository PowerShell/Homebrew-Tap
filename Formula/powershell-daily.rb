...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210227/powershell-7.2.0-daily.20210227-osx-x64.tar.gz"
  version "7.2.0-daily.20210227"
  # must be lower-case
  sha256 "d21d41558d4c10dece044b12fc6a0f89b5c66db33145341c8620d3ac0b5847d1"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210227",
