...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20201220/powershell-7.2.0-daily.20201220-osx-x64.tar.gz"
  version "7.2.0-daily.20201220"
  # must be lower-case
  sha256 "9a0c33376d6a796ce4e0c7843a927f3b69bfba5f740bcc68e1524d36697f7ee1"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20201220",
