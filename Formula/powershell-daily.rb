...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210416-1/powershell-7.2.0-daily20210416.1-osx-x64.tar.gz"
  version "7.2.0-daily20210416.1"
  # must be lower-case
  sha256 "cbdf68b27db09457ae538e9dac80b20b74875a502a5dc21c7bb6cd7aae5476be"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210416.1",
