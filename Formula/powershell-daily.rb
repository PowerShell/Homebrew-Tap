...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210610-1/powershell-7.2.0-daily20210610.1-osx-x64.tar.gz"
  version "7.2.0-daily20210610.1"
  # must be lower-case
  sha256 "cc525d7cb48834a938014f5cdebc2009470f223a252c0bd48dc3b7e91dd8fbf8"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210610.1",
