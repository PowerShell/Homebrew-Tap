...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20201117/powershell-7.1.0-daily.20201117-osx-x64.tar.gz"
  version "7.1.0-daily.20201117"
  # must be lower-case
  sha256 "d65a4e538f33154e5a6d8cc9213dced4e9b51ef80292b3d8d6be85c77589218c"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20201117",
