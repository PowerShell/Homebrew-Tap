...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200730/powershell-7.1.0-daily.20200730-osx-x64.tar.gz"
  version "7.1.0-daily.20200730"
  # must be lower-case
  sha256 "8d8bbf525c58126ea2d041cad67b7a17379290f07765cb6b817928d835e59461"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200730",
