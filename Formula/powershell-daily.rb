...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210423-1/powershell-7.2.0-daily20210423.1-osx-x64.tar.gz"
  version "7.2.0-daily20210423.1"
  # must be lower-case
  sha256 "fa860781a138e60a3bcabc934d31c20bc2b46f8dae46af11ea7460b6f08e7022"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210423.1",
