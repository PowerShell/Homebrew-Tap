...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20201029/powershell-7.1.0-daily.20201029-osx-x64.tar.gz"
  version "7.1.0-daily.20201029"
  # must be lower-case
  sha256 "10c102b6861c2c847b3821a14593042ff908c6211690293c3e86846aafc10af0"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20201029",
