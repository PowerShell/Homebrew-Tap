...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210115/powershell-7.2.0-daily.20210115-osx-x64.tar.gz"
  version "7.2.0-daily.20210115"
  # must be lower-case
  sha256 "3a1949298a9cb4251a19981dafb775c74b4e96adc685423b74cd26162baaebd6"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210115",
