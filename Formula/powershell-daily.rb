...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210830-1/powershell-7.2.0-daily20210830.1-osx-x64.tar.gz"
  version "7.2.0-daily20210830.1"
  # must be lower-case
  sha256 "ff4fc812a5ad2a79e979f1b1b42cd7532795e1067a7e1928438dc14923628218"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210830.1",
