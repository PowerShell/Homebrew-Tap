...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20211114-1/powershell-7.2.0-daily20211114.1-osx-x64.tar.gz"
  version "7.2.0-daily20211114.1"
  # must be lower-case
  sha256 "d79f3fd135c8294863edfa72c7a6e38f18fe7651cbde01fd4070f07bb27288e4"
  version_scheme 1
  ...
  test do
    assert_equal "7.2.0-daily20211114.1",
