...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210116/powershell-7.2.0-daily.20210116-osx-x64.tar.gz"
  version "7.2.0-daily.20210116"
  # must be lower-case
  sha256 "c5159bba854b6831a1ce5188699ed8b23fa23667ff201ef2442338407ab8d9c2"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210116",
