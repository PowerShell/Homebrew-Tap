...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-1-0-daily-20200723/powershell-7.1.0-daily.20200723-osx-x64.tar.gz"
  version "7.1.0-daily.20200723"
  # must be lower-case
  sha256 "d2be24ba7538914c32746f1229585461dd1d7426605b4e34bd6b217afa2d9468"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.1.0-daily.20200723",
