...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily-20210216/powershell-7.2.0-daily.20210216-osx-x64.tar.gz"
  version "7.2.0-daily.20210216"
  # must be lower-case
  sha256 "50398979617261a1d116ca35d81bf5fdb55a6394e2b9f0fdedea265152b08441"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily.20210216",
