...
class PowershellDaily < Formula
  ...
  url "https://pscoretestdata.blob.core.windows.net/v7-2-0-daily20210702-2/powershell-7.2.0-daily20210702.2-osx-x64.tar.gz"
  version "7.2.0-daily20210702.2"
  # must be lower-case
  sha256 "8e3dea453b342fa9477bdd3ca349d8f8b68d19f8533877fa3b0b2a29bd94fa69"
  version_scheme 1
  bottle :unneeded
  ...
  test do
    assert_equal "7.2.0-daily20210702.2",
