...
class Powershell < Formula
  ...
  url "https://github.com/PowerShell/PowerShell/releases/download/v7.1.4/powershell-7.1.4-osx-x64.tar.gz"
  version "7.1.4"
  # must be lower-case
  sha256 "182d3e2ddfd581725d82199d3628fd5e18cdcd4346de2fca99ae4927835451eb"
  version_scheme 1
  bottle :unneeded
